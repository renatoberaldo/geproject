...
// Tarefa responsavel por copiar os HTMLs
...
// Tarefa responsavel por copiar os CSS
...
// Tarefa responsavel por copiar os JS
...
// Tarefa para cliar a area de PRODUCAO
gulp.task('default', ['clear-build-folder'], function () {
    gulp.start('copy-html');
    elixir(function(mix){
       // Concatena todos arquivos CSS em um só, que é o All.css
       mix.styles(config.vendor_path_css.concat([config.assets_path + '/css/**/*.css' ]),
       'public/css/all.css', config.assets_path);
        // Concatena todos arquivos JS em um só, que é o All.js
